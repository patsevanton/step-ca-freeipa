...
* Развернуть FreeIPA с внешним сертификатом, например, созданным с помощью Step-CA
...
Теперь ваш центр сертификации запущен.
...
* Строфы Protect* ограничивыают доступ к системным ресурсам, поэтому процесс не может их изменять.
